...
describe(`${package}Wrapper tests`, () => {
  ...
  restTests(`${package}Wrapper works through REST`, app, errors, ownnetWrapper, 'codes', verbose, 7886);
  socketioTests(`${package}Wrapper works through socket.io`, app, errors, ownnetWrapper, 'codes', verbose, 7886);
