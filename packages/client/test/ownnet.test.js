...
describe(`${package}Wrapper tests`, () => {
  ...
  localStorageTests(`${package}Wrapper sync storage functionality`, app, errors, ownnetWrapper, 'wrapperStorage', verbose);
  asyncStorageTests(`${package}Wrapper async storage functionality`, app, errors, ownnetWrapper, 'wrapperStorage', verbose);
